...
$clientConfig = [
    ...
    'tokenPriceMinUsd' => (float) $translator->get('pricing.token_price_min_usd', [], 0.1),
    'tokenPriceMaxUsd' => (float) $translator->get('pricing.token_price_max_usd', [], 2.0),
    'tokenPriceStepUsd' => (float) $translator->get('pricing.token_price_step_usd', [], 0.1),
