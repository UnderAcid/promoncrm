...
<?php if ($pricingComparisonSystems !== []): ?>
    <section class="container pricing-comparison" id="pricing-comparison">
        ...
        <div class="comparison-slider" data-comparison-slider>
            <button class="comparison-slider-button prev" type="button" data-slider-prev aria-label="<?= e($t->get('app.slider_prev') ?? 'Previous'); ?>">
                <span class="icon arrow-left" aria-hidden="true"></span>
            </button>
            <div class="comparison-track" data-slider-track>
            ...
            <button class="comparison-slider-button next" type="button" data-slider-next aria-label="<?= e($t->get('app.slider_next') ?? 'Next'); ?>">
