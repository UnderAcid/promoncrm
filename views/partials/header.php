    ...
    <div class="container header-inner">
        ...
        <div class="actions">
            <div class="control-cluster">
                <button class="icon-button language-toggle" type="button" data-language-toggle aria-label="<?= e($t->get('language_switcher.label')); ?>" data-language-active="<?= e($currentLocale); ?>">
                ...
                <button class="icon-button theme-toggle" type="button" data-theme-toggle aria-label="<?= e($t->get('app.theme.toggle')); ?>" data-theme-active="<?= e($currentTheme); ?>">
                    <span class="icon theme-switch" aria-hidden="true"></span>
