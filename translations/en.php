...
return [
    ...
    'stack' => [
        ...
        'integrations_desc' => 'The baseline package you get on day one of the pilot.',
        'integrations_core' => 'nERP node',
        'integrations_core_desc' => 'Secure activity logging, role-based access, consolidated reports, and action-based billing. Extra connectors go into the shared pilot backlog.',
        'integrations' => [
    ...
    'pilots' => [
        ...
        'form' => [
            ...
            'token_rate' => 'Comfortable price per nERP',
            'token_rate_placeholder' => 'e.g. 0.70',
            'token_rate_suffix' => '$/nERP',
            'token_rate_hint' => 'Share the price range you expect so we can calibrate the pilot economics.',
    ...
    'momentum' => [
        ...
        'title' => 'We commit to measurable traction within six weeks',
        'subtitle' => 'A joint playbook covering node access, permissions, and the metrics your team tracks each sprint.',
        'metrics' => [
            [
                'value' => '3 weeks',
                'label' => 'to first live loop',
                'desc' => 'Roles, states, and reports configured around your priority workflow.',
            ],
            [
                'value' => '≤5h/week',
                'label' => 'from your team',
                'desc' => 'We do the heavy lifting — you only confirm edge cases and priorities.',
            ],
            [
                'value' => '2× ROI',
                'label' => 'pilot target',
                'desc' => 'Baseline KPI captured with a scale-up roadmap attached.',
            ],
        ],
        'benefits' => [
            'Launch checklist with milestones and acceptance criteria.',
            'Shared channel with the nERP team for tweaks and quick answers.',
            'Weekly status syncs plus a concise metric dashboard.',
            'Wrap-up report and rollout proposal once the pilot lands.',
        ],
        'cta_label' => 'Request the pilot plan',
        'cta_href' => '#pilots',
        'cta_secondary_label' => 'Book a slot',
        'cta_secondary_href' => '#pricing',
        'cta_note' => 'We reply within one business day with the prep checklist.',
    ],
];
