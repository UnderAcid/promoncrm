...
return [
    ...
    'pricing' => [
        ...
        'token_price_label' => 'Token price per nERP',
        'token_price_prefix' => '1 nERP =',
        'token_price_suffix' => '$',
        'token_price_hint' => 'Baseline: 1 nERP costs $1. Adjust to model $2, $3 and other scenarios.',
        ...
        'fiat_decimals' => 2,
        'base_currency' => 'USD',
        'base_currency_locale' => 'en-US',
        'token_price_step' => '0.10',
        'token_price_min' => '0.10',
