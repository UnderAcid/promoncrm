...
return [
    ...
    'pricing' => [
        ...
        'subtitle' => 'Only pay for the actions performed and tailor the estimate to your usage.',
        'team_size' => 'Team size',
        ...
        'currency_code' => 'USD',
        'currency_symbol' => '$',
        'token_label' => 'Token pricing rule',
        'token_help' => 'Adjust the token rate to instantly see the updated budget.',
        'token_default' => 1.0,
        'operations_title' => 'Base operation pricing',
        'operations' => [
            'Read one block — 0.000010 nERP',
            'Write one block — 0.000100 nERP',
            'Store one block — 0.000010 nERP · day⁻¹',
        ],
        'micro_fee' => 'nERP only charges tokens for completed actions. See the breakdown below.',
