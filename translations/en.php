...
return [
    ...
    'pricing' => [
        ...
        'token_price_label' => 'Set price per nERP token',
        'token_price_hint' => 'Baseline is $1 per nERP. Pick a preset or enter your own price to recalculate.',
        'token_price_preview_prefix' => '1 nERP ≈',
        'token_price_custom_label' => 'Or enter your own price',
        'token_price_options' => [1, 2, 3, 5],
        'usd_per_token' => 1.0,
        'token_decimals' => 6,
        'fiat_per_usd' => 1.0,
