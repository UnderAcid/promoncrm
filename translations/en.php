...
return [
    ...
    'stack' => [
        ...
        'integrations' => [
            ...
            ['name' => 'Google Sheets', 'tag' => 'Reporting', 'status' => 'Live'],
            ['name' => 'Notion Sync', 'tag' => 'Docs', 'status' => 'Beta'],
            ['name' => 'PostgreSQL', 'tag' => 'Database', 'status' => 'Live'],
            ['name' => 'SAP Connector', 'tag' => 'Enterprise', 'status' => 'Exploring'],
        ],
