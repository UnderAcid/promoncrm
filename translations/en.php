...
return [
    ...
    'pricing' => [
        ...
        'usd_equivalent' => 'Fiat equivalent',
        'hint' => 'Numbers are indicative and depend on the modules you activate.',
        'locale' => 'en-US',
        'currency' => 'USD',
        'currency_symbol' => '$',
        'token_unit' => 'nERP',
        'token_label' => 'Token price rule',
        'token_input_label' => 'Token price',
        'token_input_prefix' => '$',
        'token_input_suffix' => 'per token',
        'token_hint' => 'Tweak the rate to see how fiat totals respond.',
        'token_condition' => '1:currency = :tokens tokens',
        'token_default_price' => 1,
        'micro_fee' => 'Pay only for actions performed.',
        'operations_title' => 'Base operation costs',
        'operations_caption' => 'Token amounts stay fixed — the fiat value follows your token rate.',
        'operations' => [
            [
                'label' => 'Read a block',
                'tokens' => 0.000010,
